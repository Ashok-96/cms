...
if (isset($_POST["submit"])) {
      ...
      if ($combination=='BCA') {
          $query1="INSERT INTO `users`(`name`, `Gender`, `year`, `combination`, `reg_no`, `username`, `email`, `phonenumber`, `password`) VALUES('".$name."','".$gender."','".$year."','".$combination."','12456','".$username."','".$mail."','".$phno."','".md5($password)."')";
          $res=$db->queryRequest($query1);
          if ($res) {
      echo '<script>swal("Good job!", "registered successfully!", "success");
    </script>';    
          }else{
...
echo '<script>swal("Sorry!", "You clicked the button!", "error");
          ...
          $query1="INSERT INTO `users`(`name`, `Gender`, `year`, `combination`, `reg_no`, `username`, `email`, `phonenumber`, `password`) VALUES('".$name."','".$gender."','".$year."','".$group."','12456','".$username."','".$mail."','".$phno."','".md5($password)."')";
          $res=$db->queryRequest($query1);
        if ($res) {
